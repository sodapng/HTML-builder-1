...
4. Проверьте целостность стилей в **bundle.css**. Содержимое файлов не должно "сливаться", стили должны корректно отображаться на странице. Порядок записи файлов в **bundle.css** не имеет значения. Если **bundle.css** содержит некорректные стили задание считается не выполненным - 0 баллов.
