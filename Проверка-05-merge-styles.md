...
4. Проверьте целостность стилей в **bundle.css**. Содержимое файлов не должно "сливаться", стили должны корректно отображаться на странице. Если **bundle.css** содержит некорректные стили задание считается невыполненным - 0 баллов.
